...
sid = 'AC1defe23790c80d00fd04be4894dc1f64'

auth_token = 'b7002dfe16ca11930e908b5602edfb93'

client = Client(sid, auth_token)

resp = client.messages.create(body='A person has been detected at your work place', from_="+14752528377", to ="+919008016434")
...
url = "https://api.ycloud.com/v1/sms/send_messages"

payload = json.dumps({
  "mobile": "+919591440466",
  "text": "A person has been detected at your work place"
})
headers = {
  'X-API-Key': '9e984f46f784b6bccbe37a006ad542eb',
